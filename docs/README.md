...
| Document | About |
|---|---|
| [architecture.md](architecture.md) | The projects that exist today, the directory layout, and why the solution is cut into these layers |
| [tech-stack.md](tech-stack.md) | What CashPrism is built on — runtime, UI, web server, database, Excel, auth, delivery — and why each piece was picked |
| [ui.md](ui.md) | How the interface is laid out and themed: the drawer-and-app-bar shell, why that shape, the two palettes, and how MudBlazor's own strings are localised |
